"""
Demo script for Hamming-based McEliece cryptosystem.
"""
import numpy as np
from code.hamming_mceliece import keygen, encrypt, decrypt


def main():
    print("=" * 60)
    print("Hamming-based McEliece Cryptosystem Demo")
    print("=" * 60)
    ...
    print(f"  Hamming code: (15, 11)")
    print(f"  Message length: {11 * L} bits")
    ...
    print(f"  Error correction capability: {t} errors (1 per block)")
    ...
    decrypted = decrypt.decrypt(ciphertext, S, P, G_total, hamming_code)
